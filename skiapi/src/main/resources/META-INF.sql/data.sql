...
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (2,'Kompleks Narciarski Kopa w Karpaczu','mock','mock','mock','mock','mock',0,0,2)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (3,'Stacja Narciarska Biały Jar w Karpaczu','mock','mock','mock','mock','mock',0,0,2)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (4,'Ośrodek Narciarski Czarna Góra','mock','mock','mock','mock','mock',0,0,3)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (5,'Stacja Narciarska Kamienica','mock','mock','mock','mock','mock',0,0,3)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (6,'Stacja Narciarska Zieleniec','mock','mock','mock','mock','mock',0,0,4)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (7,'Ośrodek Ski & Sun Świeradów-Zdrój','mock','mock','mock','mock','mock',0,0,5)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (8,'Ośrodek Sportowo-Rekreacyjny Góra Dzikowiec w Boguszowie-Gorcach','mock','mock','mock','mock','mock',0,0,6)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (9,'Narciarski Raj w Chrzanowie','mock','mock','mock','mock','mock',0,0,7)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (10,'Ośrodek Sportu i Rekreacji Góra Kamieńsk','mock','mock','mock','mock','mock',0,0,8)
