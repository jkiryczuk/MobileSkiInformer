...
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (1,'SkiArena Szrenica','Turystyczna 25A','Szklarska Poręba','75 717 30 35','-','https://skimap.org/data/1865/1/1301281553.jpg',50.833333333333,15.533333333333,1)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (2,'Kompleks Narciarski Kopa w Karpaczu','Kopa','Karpacz','75 761 92 84','http://kopa.com.pl','mock',50.767083, 15.729083,2)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (3,'Stacja Narciarska Biały Jar w Karpaczu','Turystyczna 5','Karpacz','https://www.winterpol.eu/karpacz','mock','mock',50.772833, 15.738056,2)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (4,'Ośrodek Narciarski Czarna Góra','Sienna 11','Stronie Śląskie','74 884 34 06','https://czarnagora.pl','https://upload.wikimedia.org/wikipedia/commons/2/2e/Mapa_o%C5%9Brodka.jpg',50.260134, 16.819212,3)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (5,'Stacja Narciarska Kamienica','Kamienica 1a','Stronie Śląskie','74 814 32 85','http://www.snkamienica.pl','mock',50.251111, 16.886389,3)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (6,'Stacja Narciarska Zieleniec','Zieleniec 72','Duszniki-Zdrój','74 866 04 39','https://www.zieleniec.pl','mock',50.339139, 16.383056,4)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (7,'Ośrodek Ski & Sun Świeradów-Zdrój','Źródlana 7','Świeradów-Zdrój','75 615 20 20','http://skisun.pl','mock',50.910417, 15.319722	,5)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (8,'Ośrodek Sportowo-Rekreacyjny Góra Dzikowiec w Boguszowie-Gorcach','Bema','Boguszów-Gorce','74 844 70 32','http://www.dzikowiec.info','mock',50.724389, 16.219833,6)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (9,'Narciarski Raj w Chrzanowie','Chrzanów Czwarty','Chrzanów Czwarty','600 656 465','http://www.rzetelski.com.pl','mock',50.779811, 22.625372,7)
INSERT INTO ski_resorts (id,name,address,city,phonenumber,website, map_adress ,latitude,longitude,borough) values (10,'Ośrodek Sportu i Rekreacji Góra Kamieńsk','Huby Ruszczyńskie','Kamieńsk','44 737 77 30','http://gorakamiensk.info','mock',51.230833, 19.436722,8)
